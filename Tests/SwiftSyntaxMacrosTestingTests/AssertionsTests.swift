...
import SwiftSyntaxMacrosTesting
import Testing
...
struct AssertionsTests {
  ...
  @Test
  func assertMacroExpansionIgnoresHighlightMatchingIfNil() {
  ...
  @Test
  func assertMacroExpansionMatchesSingleStringHighlight() {
    assertMacroExpansion(
      "@NoStruct struct S { }",
      expandedSource: "struct S { }",
      diagnostics: [
  ...
  @Test
  func assertMacroExpansionMatchesArrayHighlight() {
    assertMacroExpansion(
      "@NoStruct struct S { }",
      expandedSource: "struct S { }",
      diagnostics: [
