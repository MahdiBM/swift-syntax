...
///
/// - SeeAlso: ``assertMacroExpansion(_:expandedSource:diagnostics:macroSpecs:applyFixIts:fixedSource:testModuleName:testFileName:indentationWidth:fileID:filePath:line:column:)``
...
public func assertMacroExpansion(
  ...
  SwiftSyntaxMacrosGenericTestSupport.assertMacroExpansion(
    ...
    failureHandler: {
      ...
      Issue.record("\($0.message)", sourceLocation: sourceLocation)
    },
